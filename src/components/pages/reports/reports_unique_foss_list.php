<?php
    ...
    $left_selected = "REPORTSUNIQUEFOSSLIST";
    $tabTitle = "SBOM - Reports (Unique FOSS List)";
...
<?php
  ...
  function getBoms($db) {
    $sql = "SELECT DISTINCT red_app_id, cmpt_name FROM apps_components;";
    $result = $db->query($sql);
      ...
      <div class="table-container">
        ...
        <?php
          ...
          elseif(isset($_COOKIE[$cookie_name]) || isset($_COOKIE[$cookie_name]) && isset($_POST['getpref'])) {
            ...
            $sql = 'SELECT DISTINCT red_app_id, cmpt_name FROM apps_components;('.$prep.')';
